...
# Uses doubleGraph A100 kernels as seeds, Modal A100 for evaluation.
#
...
# Evaluator bridges to Modal A100 via skydiscover_integration/evaluator.py
#
# Usage:
...
evaluator = KernelForgeEvaluator(
    modal_app_name='kernelforge-a100',
    target_arch='sm_80',
    eval_mode='wcc',
)
